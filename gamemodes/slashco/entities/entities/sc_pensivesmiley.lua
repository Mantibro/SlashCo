...
function ENT:FindEnemy()
	...
	if self.AttackedPlayer ~= "" then return false end
...
function ENT:Think()
	...
	if SERVER then
		...
		if self.AttackedPlayer == "" then
			...
			if not IsValid(player.GetBySteamID64(self.AttackedPlayer)) then self.AttackedPlayer = "" self.Enemy = nil end

			player.GetBySteamID64(self.AttackedPlayer):SetSlowWalkSpeed(50)
			player.GetBySteamID64(self.AttackedPlayer):SetWalkSpeed(50)
			player.GetBySteamID64(self.AttackedPlayer):SetRunSpeed(50)

			player.GetBySteamID64(self.AttackedPlayer):SetNWBool("MarkedBySmiley",true)
			...
			if self.AttackEngage == false then
				...
				timer.Simple(10, function() 
					...
					player.GetBySteamID64(self.AttackedPlayer):SetSlowWalkSpeed(200)
					player.GetBySteamID64(self.AttackedPlayer):SetWalkSpeed(200)
					player.GetBySteamID64(self.AttackedPlayer):SetRunSpeed(300)

					player.GetBySteamID64(self.AttackedPlayer):SetNWBool("MarkedBySmiley",false)

...
local function SetOfferLabel()
    offerBox.OfferLabel:SetText(string.upper( GetOfferingName(SCInfo.Offering[selectedOffer].Name)))
    offerBox.OfferModel:SetModel("models/slashco/other/offerings/o_" .. selectedOffer .. ".mdl")
    offerBox.OfferDesc:SetText(SlashCoLanguage(SCInfo.Offering[selectedOffer].Name.."_desc"))
end
...
local function DrawOfferSelectorBox()
    ...
    offerBox:SetTitle("["..string.upper(SlashCoLanguage("offering_idle")).."...]")
    ...
    for k, p in SortedPairs(SCInfo.Offering) do
        ...
        offer:SetText(string.upper(GetOfferingName(p.Name)))

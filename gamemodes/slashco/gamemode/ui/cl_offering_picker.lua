...
local function SetOfferLabel()
	offerBox.OfferLabel:SetText(string.upper(SlashCo.Language("Offering_name", SCInfo.Offering[selectedOffer].Name)))
...
local function DrawOfferSelectorBox()
	...
	for k, p in SortedPairs(SCInfo.Offering) do
		...
		offer:SetText(string.upper(SlashCo.Language("Offering_name", p.Name)))

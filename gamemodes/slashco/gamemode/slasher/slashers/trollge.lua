...
SlashCoSlasher.Trollge.Description = "Trollge_desc"
SlashCoSlasher.Trollge.ProTip = "Trollge_tip"
...
SlashCoSlasher.Trollge.PickUpAttempt = function()
	return false
end
...
SlashCoSlasher.Trollge.Footstep = function()
	return true
end
...
if CLIENT then
	...
	SlashCoSlasher.Trollge.InitHud = function(_, hud)

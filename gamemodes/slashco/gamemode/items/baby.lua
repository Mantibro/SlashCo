...
SlashCo.Items.Baby.Model = "models/props_c17/doll01.mdl"
SlashCo.Items.Baby.Name = "The Baby"
SlashCo.Items.Baby.Icon = "slashco/ui/icons/items/item_7"
SlashCo.Items.Baby.Price = 35
SlashCo.Items.Baby.Description = "A decrepit-looking doll of a baby. Upon use, this item will halve your \nhealth and teleport you away from the slasher. \nThe lower your health, the more likely you are to\nsuffer a premature death upon use."
SlashCo.Items.Baby.CamPos = Vector(50,0,0)
SlashCo.Items.Baby.OnUse = function(ply)
...
SlashCo.Items.Baby.OnDrop = function(ply)
